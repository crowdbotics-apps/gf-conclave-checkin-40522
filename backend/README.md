...
## Project Structure
    ...
    ├── gf_conclave_checkin_40522  # Django project configurations
...
1. Clone this repo and `cd gf_conclave_checkin_40522`
...
2. Clone this repo and `cd gf_conclave_checkin_40522`
